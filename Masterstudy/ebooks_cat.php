...
<html><head>
   ...
   <li><a href='impdates_cat.html'>Important Dates</a></li>
    <li><a href='examtips_cat.html'>Exam Tips</a></li>
	 <li class='active'><a href='ebooks_cat.php'>Ebooks</a></li>						
...
<ul>
    ...
    <li ><a href='syll_cat.html'>Syllabus</a></li>
    <li><a href='impdates_cat.html'>Important Dates</a></li>
    <li><a href='analysis_cat.html'>Analysis of Paper Pattern</a></li>
    <li ><a href='examtips_cat.html'>Exam Tips</a></li>
    <li><a href='eli_cat.html'>Eligibilty</a></li>
	<li class='active'><a href='ebooks_cat.php'>Ebooks</a></li>
</ul>
					...
					<a href="#" class="image fit" style="width:auto; height:320px;"><img src="img/prev.jpg" alt="" /></a>
     					<h4>Recommended BOOKS for CAT</h4>										
				<?php
// Attempt select query execution
$result = mysql_query("SELECT distinct topic_id FROM book_cat ");
if($result){
    if(mysql_num_rows($result) > 0){
                  while($row = mysql_fetch_array($result)){ ?>
				   ...
				   if($topic2=='VB')
						{
							$head='VERBAL AND NON VERBAL REASONING';
						}
                        if($topic2=='LR')
						{
							$head='DATA INTERPRETATION AND LOGICAL REASONING';
						}
                        if($topic2=='APT')
						{
							$head='QUANTATIVE APTITUDE';
						}
                        
				   echo $head; ?> </h3> 			
		      <?php
			  $result2= mysql_query("SELECT * FROM book_cat WHERE topic_id = '$topic2'");
			  if($result2){
