...
<html><head>
   ...
   <li class='active'><a href='videos_gate_cse.php'>Video Lectures</a></li>
	 ...
	 <li ><a href='ebooks_cat.php'>Ebooks</a></li>						
			...
			<!-- Main -->
				<div id="main" class="wrapper style1">
					<div class="container">
						<header class="major">
							<h2>VIDEOS FOR PREPARATION-GATE CSE</h2>
						</header>
						<div class="row 150%">
...
$result = mysql_query("SELECT distinct topic_id FROM video_link ");
if($result){
    if(mysql_num_rows($result) > 0){
                  while($row = mysql_fetch_array($result)){ ?>
				   ...
				   echo $head; ?> </h3> 			
		      <?php
			  $result2= mysql_query("SELECT * FROM video_link WHERE topic_id = '$topic2'");
			  if($result2){
