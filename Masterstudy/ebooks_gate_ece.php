...
<html><head>
   ...
   <li ><a href='analysis_ece.html'>Analysis</a></li>
    <li><a href='examtips_ece.html'>Exam Tips</a></li>
	 <li class='active'><a href='ebooks_ece.php'>Ebooks</a></li>
...
<ul>
  <li><a href='#'>Home</a></li>
   ...
   <li ><a href='syll_ece.html'>Syllabus</a></li>
   <li><a href='impdates_ece.html'>Important Dates</a></li>
   <li><a href='eli_ece.html'>Eligibility</a></li>
   <li><a href='analysis_ece.html'>Analysis of Paper Pattern</a></li>
    <li><a href='examtips_ece.html'>Exam Tips</a></li>
	 <li class='active' ><a href='ebooks_gate_ece.php'>Ebooks</a></li>
</ul>
</div>
							...
							<div class="8u$ 12u$(medium) important(medium)">
								...
								<!-- Content -->
									<section id="content">
					<a href="#" class="image fit" style="width:auto; height:320px;"><img src="img/prev.jpg" alt="" /></a>
     					<h4>Recommended BOOKS for GATE ECE</h4>										
				<?php
// Attempt select query execution
$result = mysql_query("SELECT distinct topic_id FROM book_ece ");
if($result){
    if(mysql_num_rows($result) > 0){
                  while($row = mysql_fetch_array($result)){ ?>
				   ...
				   echo $head; ?> </h3> 			
		      <?php
			  $result2= mysql_query("SELECT * FROM book_ece WHERE topic_id = '$topic2'");
			  if($result2){
