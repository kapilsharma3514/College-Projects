 ...
 <!--//           </div>
  ...
  <!--//      
    ...
    <div id="services" class="container">
        ...
        <!-- SERVICE ITEMS START -->
        <div class="row">
               <a data-popup-open="popup-4" href="#" style="text-decoration:none;color:black;"><div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                   <img src="img/service_01.png" alt="">
                   <h4>Previous Year Papers</h4>
                   <p>Access Previous Year Papers for various exams like GATE, CAT, GRE and many more.</p>
                </div></a> <!-- ITEM END -->
                ...
                <a data-popup-open="popup-3" href="#" style="text-decoration:none;color:black;"><div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                   ...
                   <h4>Exam Tips</h4>
                   <p>Confused how to approach an exam ? Have a look at our exam tips.</p>
                </div></a> <!-- ITEM END -->
                ...
                <a data-popup-open="popup-1" href="#" style="text-decoration:none;color:black;"><div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                   ...
                   <h4>Syllabus</h4>
                   <p>Unsure of the syllabus ? Check out the correct syllabus here.</p>
                </div></a> <!-- ITEM END -->

               <a data-popup-open="popup-2" href="#" style="text-decoration:none;color:black;"><div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                   <img src="img/service_04.png" alt="">
                   <h4>Important Dates</h4>
                   <p>Keep an eye on important dates. Do not miss out on last date for an exam.</p>
                </div></a>

				<a data-popup-open="popup-5" href="#" style="text-decoration:none;color:black;"><div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                   <img src="img/service_01.png" alt="">
                   <h4>E-Books</h4>
                   <p>Get access to all the books you would require for your preparation.</p>
                </div></a>
				
				<a data-popup-open="popup-6" href="#" style="text-decoration:none;color:black;"><div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                   <img src="img/service_02.png" alt="">
                   <h4>Eligibility</h4>
                   <p>Check out eligibility criteria for the different competetive exams.</p>
                </div></a><!-- ITEM END -->
<!--//
        ...
        <div class="container">
            ...
            <div class="footerlinks"><!-- FOOTER LINKS START -->            
                <ul>
                    ...
                    <li><a href="mailto:shubhanshu12@gmail.com">Contact</a></li>                   
                </ul>
...
Forenoon : 9.00 AM to 12.00 Noon<br/>
    ...
    <div class="popup-inner">
       ...
       <center> <p style="margin-top:10px;margin-bottom:50px;">
		...
		<div id="gatecsepapers" style=";">
			...
			<li><a href="papers/gate/cse/CS-2012">GATE - CSE Paper, 2012</a></li><br/>
		...
		<div id="gateecepapers" style="display:none;">
			...
			<li><a href="papers/gate/ece/EC-2012.pdf">GATE - ECE Paper, 2012</a></li><br/>
		...
		<div id="gateeepapers" style="display:none;">
			...
			<li><a href="#">GATE - EE Paper, 2012</a></li><br/>
		...
		<div id="catpapers" style="display:none;">
			...
			<li><a href="papers/cat/CAT-Paper-2012.pdf" target="_blank">CAT Paper, 2012</a></li><br/>
             ...
             <li><a href="https://app.box.com/s/4g2lswbfrc2ixw1txi0tffy573tm5ek2">Principles of Communication Systems by Taub Schilling </a></li><br/>
              <li><a href="https://app.box.com/s/jv3ezqgv5j9wpktn662ewmm2chzgw54l">Morris Mano Digital Design 3rd Edition </a></li><br/>
               <li><a href="https://app.box.com/s/1m9g4te2ghrsuabr6hrc2pbi73lfos2k">Modern digital and analog communication - B P Lathi </a></li><br/>
                <li><a href="https://app.box.com/s/7imqoze1vpun6m7vwhn97f5gdh3476kp">Microwave Engineering David M Pozar 4ed Wiley 2012 </a></li><br/>
                 <li><a href="https://app.box.com/s/c2ss3zvky2rqnjftfor82vg71r6ufkyw">Principles of Electronics by V. K. Mehta </a></li><br/>
            
            
            
            <!--<li><a href="#">GATE - ECE Paper, 2012</a></li><br/>
